...
![Patrón Productor-Consumidor de Synergia](../../../../public/images/tfg/patron-productor-consumidor.png)
...
![Patrón Fachada en la Capa de Datos](../../../../public/images/tfg/patron-fachada.png)
...
![Patrón Estrategia (Múltiples DB Engines)](../../../../public/images/tfg/patron-estrategia.png)

:::note[Por qué se eliminó]
Por consideraciones realizadas a posteriori, este componente fue eliminado una vez se realizó la migración a Oracle de forma exitosa. Al consolidarse Oracle como único motor de base de datos (necesario para aprovechar sus *Blockchain Tables*, ver [Modelo de Datos](../modelo-de-datos/)), mantener una capa de abstracción para un motor alternativo que ya no se iba a usar añadía complejidad sin aportar valor real.
:::
...
![Patrón Singleton en Componentes Compartidos](../../../../public/images/tfg/patron-singleton.png)
...
* **`process`** — subdivisión concreta de trabajo asociada a una tarea, conocida como *proceso* (ver [Glosario](../glosario/)).
...
La separación entre tareas, procesos y ejecuciones permite distribuir el trabajo de manera independiente entre múltiples workers y facilita la implementación de mecanismos de validación y tolerancia a fallos. El esquema entidad-relación completo se detalla en [Modelo de Datos](../modelo-de-datos/).
